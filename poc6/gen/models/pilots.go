...
var PilotWhere = struct {
	...
	Age:  whereHelperint{field: "`pilots`.`age`"},
}
...
var (
	pilotAllColumns            = []string{"id", "name", "age"}
	pilotColumnsWithoutDefault = []string{"id", "name", "age"}
...
// Panics on error.
func (o *Pilot) AddLanguagesP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Language) {
	if err := o.AddLanguages(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Panics on error.
func (o *Pilot) SetLanguagesP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Language) {
	if err := o.SetLanguages(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Panics on error.
func (o *Pilot) RemoveLanguagesP(ctx context.Context, exec boil.ContextExecutor, related ...*Language) {
	if err := o.RemoveLanguages(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func FindPilotP(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) *Pilot {
...
func (o *Pilot) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) {
...
func PilotExistsP(ctx context.Context, exec boil.ContextExecutor, iD int) bool {
