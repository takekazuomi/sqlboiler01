...
func FindJetP(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) *Jet {
...
func (o *Jet) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) {
...
func JetExistsP(ctx context.Context, exec boil.ContextExecutor, iD int) bool {
