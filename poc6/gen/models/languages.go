...
func (languageL) LoadPilots(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLanguage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("`pilots`.`id`, `pilots`.`name`, `pilots`.`age`, `a`.`language_id`"),
		qm.From("`pilots`"),
...
// Panics on error.
func (o *Language) AddPilotsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) {
	if err := o.AddPilots(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Panics on error.
func (o *Language) SetPilotsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) {
	if err := o.SetPilots(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Panics on error.
func (o *Language) RemovePilotsP(ctx context.Context, exec boil.ContextExecutor, related ...*Pilot) {
	if err := o.RemovePilots(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func FindLanguageP(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) *Language {
...
func (o *Language) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) {
...
func LanguageExistsP(ctx context.Context, exec boil.ContextExecutor, iD int) bool {
