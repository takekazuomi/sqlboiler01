...
var UserWhere = struct {
	...
	Memo:      whereHelperstring{field: "`users`.`memo`"},
...
var (
	userAllColumns            = []string{"id", "name", "memo", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "memo", "created_at", "updated_at"}
