...
// OneP returns a single table2 record from the query, and panics on error.
func (q table2Query) OneP(ctx context.Context, exec boil.ContextExecutor) *Table2 {
...
// AllP returns all Table2 records from the query, and panics on error.
func (q table2Query) AllP(ctx context.Context, exec boil.ContextExecutor) Table2Slice {
...
// CountP returns the count of all Table2 records in the query, and panics on error.
func (q table2Query) CountP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q table2Query) ExistsP(ctx context.Context, exec boil.ContextExecutor) bool {
...
// SetTable1P of the table2 to the related item.
// Sets o.R.Table1 to related.
// Adds o to related.R.Table2s.
// Panics on error.
func (o *Table2) SetTable1P(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Table1) {
	if err := o.SetTable1(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// FindTable2P retrieves a single record by ID with an executor, and panics on error.
func FindTable2P(ctx context.Context, exec boil.ContextExecutor, iD ulid.ULID, selectCols ...string) *Table2 {
	retobj, err := FindTable2(ctx, exec, iD, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *Table2) InsertP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) {
...
// UpdateP uses an executor to update the Table2, and panics on error.
// See Update for more documentation.
func (o *Table2) UpdateP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) int64 {
...
func (q table2Query) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o Table2Slice) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o *Table2) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) {
...
// DeleteP deletes a single Table2 record with an executor.
// DeleteP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *Table2) DeleteP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q table2Query) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o Table2Slice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o *Table2) ReloadP(ctx context.Context, exec boil.ContextExecutor) {
...
// Panics on error.
func (o *Table2Slice) ReloadAllP(ctx context.Context, exec boil.ContextExecutor) {
...
// Table2ExistsP checks if the Table2 row exists. Panics on error.
func Table2ExistsP(ctx context.Context, exec boil.ContextExecutor, iD ulid.ULID) bool {
	e, err := Table2Exists(ctx, exec, iD)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
// Exists checks if the Table2 row exists.
func (o *Table2) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return Table2Exists(ctx, exec, o.ID)
}
