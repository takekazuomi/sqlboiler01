...
var Table1TableColumns = struct {
	...
	ID:        "table1.id",
	Name:      "table1.name",
	CreatedAt: "table1.created_at",
	UpdatedAt: "table1.updated_at",
...
var Table1Where = struct {
	...
	Name:      whereHelperstring{field: "`table1`.`name`"},
	CreatedAt: whereHelpertime_Time{field: "`table1`.`created_at`"},
	UpdatedAt: whereHelpertime_Time{field: "`table1`.`updated_at`"},
...
var (
	table1AllColumns            = []string{"id", "name", "created_at", "updated_at", "deleted_at"}
	table1ColumnsWithoutDefault = []string{"name", "created_at", "updated_at", "deleted_at"}
...
var table1AfterSelectMu sync.Mutex
var table1AfterSelectHooks []Table1Hook

var table1BeforeInsertMu sync.Mutex
var table1BeforeInsertHooks []Table1Hook
var table1AfterInsertMu sync.Mutex
var table1AfterInsertHooks []Table1Hook

var table1BeforeUpdateMu sync.Mutex
var table1BeforeUpdateHooks []Table1Hook
var table1AfterUpdateMu sync.Mutex
var table1AfterUpdateHooks []Table1Hook

var table1BeforeDeleteMu sync.Mutex
var table1BeforeDeleteHooks []Table1Hook
var table1AfterDeleteMu sync.Mutex
var table1AfterDeleteHooks []Table1Hook

var table1BeforeUpsertMu sync.Mutex
var table1BeforeUpsertHooks []Table1Hook
var table1AfterUpsertMu sync.Mutex
...
func FindTable1P(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) *Table1 {
...
func (o *Table1) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(table1AllColumns, strmangle.SetIntersect(insert, update))
...
// Panics on error.
func (o *Table1) DeleteP(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) int64 {
...
func (q table1Query) DeleteAllP(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) int64 {
...
func (o Table1Slice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) int64 {
...
func Table1ExistsP(ctx context.Context, exec boil.ContextExecutor, iD int) bool {
